            ...
            switch (cmd) {
                case 1:
                    ...
                    while (cr0Active) {
                        ...
                        System.out.println("Military unArmed Robot");
                        ...
                        switch (cmd1) {
                            case 1:
                                while (c != 0) {
                                    c--;
                                    WarMachines curr = wService.CreateWarMachine();
                            ...
                            case 2:
                                while (c != 0) {
                                    c--;
                                    Defense curr = dService.CreateDefense();
                            ...
                            case 3:
                                while (c != 0) {
                                    c--;
                                    Rescue curr = rService.CreateRescue();
                            ...
                            case 4:
                                while (c != 0) {
                                    c--;
                                    Sprayer curr = sService.CreateSprayer();
                            ...
                            case 5:
                                while (c != 0) {
                                    c--;
                                    Seeding curr = service.CreateSeeding();
                                    String text = service.SeedingToTxt(curr);
                                    SeedService.writeToFile(path + "\\" + name+ ".txt", text);
                ...
                case 2:
                    ...
                    while (cr1Active) {
                        ...
                        int cmd1 = x.nextInt();
                        if (cmd1<1  || cmd1>6)break;
                        System.out.println("Give me you Robot Data .txt path");
                        String path = x.next();
                        String[] arr;
                        switch (cmd1){
                            case 1:
                        ...
                        switch (cmd1){
                            case 1:
                                while (c<warRobots.size()){
                                    warRobots.get(c++).PrintRobotData();
                                }
                                break;
                            case 2:
                                while (c<defRobots.size()){
                                    defRobots.get(c++).PrintRobotData();
                                }
                                break;
                            case 3:
                                while (c<rescueRobots.size()){
                                    rescueRobots.get(c++).PrintRobotData();
                                }
                                break;
                            case 4:
                                while (c<sprayerRobots.size()){
                                    sprayerRobots.get(c++).PrintRobotData();
                                }
                                break;
                            case 5:
                                while (c<seedingRobots.size()){
                                    seedingRobots.get(c++).PrintRobotData();
                                }
                                break;
                    }
