...
public class WarMachines extends Armed {
    ...
    public void CreateRobot(Scanner scanner) {
        ...
        this.setKillsCount(scanner.nextInt());
        System.out.println("Combat Range (close-mid-far)");
        this.setCombatDistance(scanner.next().charAt(0));
        System.out.println("Has an Extra gun slot?yes or no");
        this.setExtraGunSlot(scanner.next().charAt(0)=='y');
        System.out.println("Battlefield deployment average time");
        this.setDeployInBattlefield_AverageTime(scanner.nextDouble());
        System.out.println("How long Robot can stand?");
        this.setBattleResistance_AverageTime(scanner.nextDouble());
    }
}
